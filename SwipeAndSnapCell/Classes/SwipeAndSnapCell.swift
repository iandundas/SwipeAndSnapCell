...
public class SwipeAndSnapCell: UITableViewCell{
    ...
    func didTapCell(){
        ...
        while let superview = view?.superview{
            ...
            if let tableView = superview as? UITableView, let indexPath = tableView.indexPathForCell(self), let delegate = tableView.delegate {
...
extension SwipeAndSnapCell: UIScrollViewDelegate{
    ...
    private func mutate(layoutConstraint: NSLayoutConstraint, constant: CGFloat, withAnimationDuration duration: NSTimeInterval){
        let mutation = {
